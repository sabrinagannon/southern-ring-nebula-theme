...
;;; southern-ring-nebula-dark-theme.el
...
(deftheme southern-ring-nebula-dark)
...
(provide-theme 'southern-ring-nebula-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; southern-ring-nebula-dark-theme.el ends here
